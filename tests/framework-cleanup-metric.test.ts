...
// Codex hardening for plan 162 redacts JSON/run/plan identifiers, missing-plan errors, and fixes final evidence-before-verify resume guidance.
const cleanupTargetLoc = 16_011;
...
describe('framework cleanup maintained-source metric', () => {
  it('measures the maintained TypeScript surface with the agreed roots', () => {
    ...
    expect(cleanupTargetLoc).toBe(16_011);
