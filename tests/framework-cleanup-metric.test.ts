...
// Controlled runtime parity deliberately adds one bounded adapter launcher; keep the cap explicit so future growth must update this test with intent.
const cleanupTargetLoc = 14_341;
...
describe('framework cleanup maintained-source metric', () => {
  it('measures the maintained TypeScript surface with the agreed roots', () => {
    ...
    expect(cleanupTargetLoc).toBe(14_341);
