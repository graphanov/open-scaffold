...
// Codex hardening for plan 162 redacts JSON/run/plan identifiers, missing-plan errors, workspace paths, .osc/run/evidence/lesson symlinks, mission/plan-file/stage/root symlinks, and fixes final evidence-before-verify resume guidance.
const cleanupTargetLoc = 16_052;
...
describe('framework cleanup maintained-source metric', () => {
  it('measures the maintained TypeScript surface with the agreed roots', () => {
    ...
    expect(cleanupTargetLoc).toBe(16_052);
