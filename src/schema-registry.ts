...
export const SCHEMA_REGISTRY: SchemaRegistryEntry[] = [
  ...
  { id: 'open-scaffold.evolution-attempt.v1', owner: 'src/evolution.ts', maturity: 'lab', emittedBy: ['osc evolve record'], shape: 'Append-only attempt journal entries with run/evaluation/receipt/evidence refs, decision, score, rationale, optional usage, and retry repair-hypothesis control fields.' },
