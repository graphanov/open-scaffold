...
export const SCHEMA_REGISTRY: SchemaRegistryEntry[] = [
  ...
  { id: 'osc.harness-status.v1', owner: 'src/harness.ts', maturity: 'lab', emittedBy: ['osc harness', '$interview', '$plan', '$work', '$team'], shape: 'Transport-neutral harness run status with command, state, pending human gates, artifact links, worker statuses, and owner-boundary flags.' },
  { id: 'osc.harness-event.v1', owner: 'src/harness.ts', maturity: 'lab', emittedBy: ['osc harness'], shape: 'Append-only JSONL event records for command_started, human_gate, human_gate_answered, command_blocked, and command_completed.' },
  { id: 'osc.controlled-work-run.v1', owner: 'src/harness.ts', maturity: 'lab', emittedBy: ['osc harness $work'], shape: 'Bounded work package with intent, context, runtime adapter boundary, gates, evidence links, feedback path, inherited improvements, and no-core-spawn boundary.' },
  ...
  { id: 'osc.handoff-compiler.v1', owner: 'src/handoff.ts', maturity: 'lab', emittedBy: ['osc bench handoff-lab', 'harness handoff compiler'], shape: 'Compact continuation packet with required State, Decisions, Blockers, Evidence refs, and Next Actions sections under a character budget.' },
