...
export const SCHEMA_REGISTRY: SchemaRegistryEntry[] = [
  ...
  { id: 'osc.ambient-work-record.v1', owner: 'src/ambient.ts', maturity: 'lab', emittedBy: ['ambient hook postflight'], shape: 'Post-hoc work record extracted by the harness from run packet, artifacts, and evidence paths so workers do not spend context hand-writing bookkeeping.' },
