...
Open Scaffold is a runtime-neutral, repo-native work record for AI-assisted software: a portable methodology and repository protocol that lets humans, AI agents, and orchestrators plan, execute, verify, publish, and evolve software work without losing context or ownership.
