...
- `git diff --check` — pass.
- `npm test -- --run tests/metrics.test.ts` — pass; 1 file / 8 tests.
- `npm test -- --run` — pass; 32 files / 280 tests.
