...
- `git diff --check` — PASS.
- `npm test -- tests/blueprint-mega.test.ts tests/cli-dispatch.test.ts tests/cli-lifecycle-help.test.ts --run` — PASS in focused verification.
- `npm test -- --run` — PASS: 56 test files, 589 tests.
