...
- `git diff --check` — PASS.
- `npm test -- tests/blueprint-mega.test.ts tests/cli-dispatch.test.ts tests/cli-lifecycle-help.test.ts tests/section-parser.test.ts tests/github-actions-workflows.test.ts --run` — PASS in focused verification: 5 files, 73 tests.
- `npm test -- --run` — PASS: 56 test files, 613 tests.
