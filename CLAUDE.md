...
- **Stability and launch docs** — `docs/STABILITY.md`, `docs/CHANGELOG.md`, and `docs/index.html` explain the v1.0.0 stable contract, curated release history, and landing-page adoption path. Treat `package.json`, npm latest, and GitHub Releases as separate public truth surfaces; repo version alone does not prove publication.
